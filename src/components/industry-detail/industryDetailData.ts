...
export const INDUSTRY_DETAILS: Record<string, IndustryDetailData> = {
  ...
  'healthcare': {
    ...
    heroHeadline: 'Digital health architectures built for trust and clinical velocity.',
    ...
    challenges: [
      {
        id: 'telehealth-video',
        title: 'WebRTC Telehealth & Video Consultations',
        oneLiner: 'Ultra-low latency HD clinical video with in-session encrypted EHR notes.',
        problem: 'Video dropouts during remote medical consultations frustrate clinicians and compromise patient care.',
        btmCapability: 'Scalable WebRTC infrastructure + adaptive bitrate video routing + encrypted session recordings.',
        technology: ['React', 'WebRTC', 'Python', 'Node.js', 'AWS HIPAA'],
        actionLabel: 'Explore Telehealth Pod',
      },
      {
        id: 'ehr-interoperability',
        title: 'EHR/EMR Interoperability (HL7 & FHIR)',
        oneLiner: 'Seamless bi-directional connectors for Epic, Cerner & Allscripts medical records.',
        problem: 'Siloed hospital EHR systems prevent clinical data sharing across specialized provider networks.',
        btmCapability: 'SMART-on-FHIR protocol bridges + HL7 v2/v3 message parsers + secure patient identity matching.',
        technology: ['Python', 'Java', 'FastAPI', 'PostgreSQL', 'Docker'],
        actionLabel: 'Explore EHR Connectors',
      },
      {
        id: 'patient-portal',
        title: 'Patient Engagement & Self-Service Portals',
        oneLiner: 'Intuitive scheduling, e-prescriptions, lab results & encrypted patient messaging.',
        problem: 'Poor patient digital portals drive high call center volume and missed appointment rates.',
        btmCapability: 'Responsive patient web and mobile apps with biometric login and automated SMS/email reminders.',
        technology: ['React', 'React Native', 'TypeScript', 'Node.js', 'PostgreSQL'],
        actionLabel: 'Explore Patient Portals',
      },
      {
        id: 'remote-monitoring',
        title: 'Remote Patient Monitoring (RPM) Telemetry',
        oneLiner: 'Encrypted IoT ingestion pipelines for blood pressure, glucose & cardiac monitors.',
        problem: 'Continuous vitals from wearable devices generate massive noisy streams that overwhelm medical staff.',
        btmCapability: 'Time-series vitals processing + automated anomaly threshold triggers + clinician alerts.',
        technology: ['Python', 'TimescaleDB', 'Kafka', 'MQTT', 'AWS'],
